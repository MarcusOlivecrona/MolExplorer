...
import {TableWidget} from "models/widgets/table_widget"
...
export class HighTableView extends WidgetView
...
export class HighTable extends TableWidget
  type: 'HighTable'
  default_view: HighTableView
